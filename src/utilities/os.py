...
def safe_full_filename(full_filename: str, fallback_filename: str, filename_prefix: Optional[str] = None, max_length: int = 255) -> str:
    split_full_filename: List[str] = full_filename.rsplit(".", 1)
    filename: str = split_full_filename[0]
    file_extension: str = split_full_filename[len(split_full_filename) - 1]
